...
from scores.models import Tournament, Team, Fixture

TEAMS = ['Arsenal', 'Aston Villa', 'Bournemouth', 'Brighton', 'Burnley', 'Chelsea', 'Crystal Palace', 'Everton',
         'Leicester', 'Liverpool, Manchester City', 'Manchester United', 'Newcastle', 'Norwich', 'Sheffield United',
         'Southampton', 'Tottenham', 'Watford', 'West Ham', 'Wolves', "Willows"]
